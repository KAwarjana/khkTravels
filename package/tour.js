...
function showSlides9() {
  ...
  slideIndex9++;
  if (slideIndex9 > slides.length) {slideIndex9 = 1}
...
function showSlides11() {
  ...
  setTimeout(showSlides11, 5000); // Change image every 2 seconds
}
...
function showSlides12() {
  ...
  setTimeout(showSlides12, 5000); // Change image every 2 seconds
}
